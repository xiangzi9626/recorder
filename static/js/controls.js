...
oBtn.addEventListener('touchend', function () {
  ...
  recorder.getMp3Blob(function (blob) {
    ...
    // 给图片添加路径
    oImg.src = '/static/images/picture.jpg';
    ...
    setTimeout(function () {
      ...
      if (isNaN(nDuration) || nDuration === 0) {
        ...
        setTimeout(function () {
          ...
          oMarkIcon.style.backgroundImage = 'url(/static/images/voice.png)';
        ...
        oSpanPlay.onclick = function () {
          if (bMark) {
            this.style.backgroundImage = 'url(/static/images/voiceplayer1.gif)';
            oAudio.play();
            oAudio.addEventListener('timeupdate', function () {
              if (this.ended) {
                oSpanPlay.style.backgroundImage = 'url(/static/images/voice2.png)';
              }
            });
          } else {
            this.style.backgroundImage = 'url(/static/images/voice2.png)';
            oAudio.pause();
          }
          bMark = !bMark;
        }
